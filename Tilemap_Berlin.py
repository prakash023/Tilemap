# -*- coding: utf-8 -*-
 HEAD:Tilemap_Berlin.py
"""Tile_in Cells_.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1UjZfacmwlVfrLJ9Sd8YA8W5Uqt8LIuyM
"""


 65bfea32e9a973002dccd0325223fecc07bbb0fe:tilemap_.py
    ...
    with output:
      ...
      while len(grid) != len(bezirke):  # The size of the grids are defined which results in making the different results.
          if len(grid) < len(bezirke):
              grid_width *= 0.98    #like here change the width and the height to 70 for rectangle, by default it is set on 98!
              grid_height *= 0.98   #the result may vary with the increase or decrease in the width and height.
          else:
              grid_width *= 1.02
              grid_height *= 1.02
...
def export_geojson(button):
    """Export the current grid as a GeoJSON file."""
    ...
    # Construct output filename based on original file and tile shape
